...
export const SOUND_PACKS = [
    { 
        ...
        name: 'Zen', 
        cost: 0, 
        imageSrc: '/assets/sound-pack-icons/zen_icon.webp',
        icon: Icons.Wind,
    ...
    { 
        ...
        name: 'Paper', 
        cost: 200, 
        imageSrc: '/assets/sound-pack-icons/paper_icon.webp',
        icon: Icons.Paper, 
    ...
    },
    {
        ...
        name: 'Stone',
        cost: 200,
        imageSrc: '/assets/sound-pack-icons/stone_icon.webp',
        icon: Icons.Mountain,
    ...
    { 
        ...
        name: 'Water', 
        cost: 200, 
        imageSrc: '/assets/sound-pack-icons/water_icon.webp',
        icon: Icons.Water, 
    ...
    },
    {
        ...
        name: 'Type',
        cost: 200,
        imageSrc: '/assets/sound-pack-icons/type_icon.webp',
        icon: Icons.Keyboard,
    ...
    },
    {
        ...
        name: '8-Bit',
        cost: 400,
        imageSrc: '/assets/sound-pack-icons/8bit_icon.webp',
    ...
    },
    {
        ...
        name: 'Crystal',
        cost: 400,
        imageSrc: '/assets/sound-pack-icons/crystal_icon.webp',
        icon: Icons.Gem,
    ...
    { 
        ...
        name: 'Wood', 
        cost: 400, 
        imageSrc: '/assets/sound-pack-icons/wood_icon.webp',
        icon: Icons.Wood, 
    ...
    { 
        ...
        name: 'Piano', 
        cost: 700, 
        imageSrc: '/assets/sound-pack-icons/piano_icon.webp',
        icon: Icons.Piano,
    ...
    },
    {
        ...
        name: 'Koto',
        cost: 700,
        imageSrc: '/assets/sound-pack-icons/koto_icon.webp',
        icon: Icons.Koto,
